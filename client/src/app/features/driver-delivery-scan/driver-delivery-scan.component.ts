...
@Component({
  selector: 'app-driver-delivery-scan',
  standalone: true,
  imports: [CommonModule, RouterLink],
  templateUrl: './driver-delivery-scan.component.html',
  styleUrl: './driver-delivery-scan.component.css',
})
export class DriverDeliveryScanComponent implements OnDestroy {
